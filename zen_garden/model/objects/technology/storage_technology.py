...
class StorageTechnology(Technology):
    ...
    def construct_vars(cls, optimization_setup):
        ...
        #charge discharge binaries
        if optimization_setup.system.storage_charge_discharge_binary:
            variables.add_variable(model,name="charge_storage_binary", index_sets=(index_values, index_names), binary=True, doc = "charge binary for storage technology", unit_category=None)
    ...
    def construct_constraints(cls, optimization_setup):
        ...
        #Add binary for charge and discharge
        if optimization_setup.system.storage_charge_discharge_binary:
